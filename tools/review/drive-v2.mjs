...
const OUT='docs/review-shots/v2'; let n=0;
...
await page.goto('http://127.0.0.1:8765/journey-planner.html'); await page.waitForFunction(()=>!!window.planner && window.planner.version==='planner/2', undefined, {timeout:60000});
